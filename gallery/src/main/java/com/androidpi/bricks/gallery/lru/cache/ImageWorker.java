...
package com.androidpi.bricks.gallery.lru.cache;
...
import com.androidpi.bricks.gallery.task.AsyncExecutor;
...
public abstract class ImageWorker {
     ...
     * ImageWorker#addImageCache(FragmentManager,
    ...
    public void addImageCache(
            FragmentManager fragmentManager, ImageCache.ImageCacheParams cacheParams) {
     ...
     *
     * @param activity
     * @param diskCacheDirectoryName See {@link
     *     ImageCache.ImageCacheParams#ImageCacheParams(android.content.Context, String)} .
     */
    public void addImageCache(FragmentActivity activity, String diskCacheDirectoryName) {
        mImageCacheParams = new ImageCache.ImageCacheParams(activity, diskCacheDirectoryName);
        mImageCache =
                ImageCache.getInstance(activity.getSupportFragmentManager(), mImageCacheParams);
        new CacheAsyncTask().execute(MESSAGE_INIT_DISK_CACHE);
    }
     ...
     *     ImageWorker#loadImage(Object, android.widget.ImageView)}
     ...
     * activity is destroyed (for example during {@link Activity#onPause()}), or there
    ...
    protected class CacheAsyncTask extends AsyncTask<Object, Void, Object> {

        @Override
        protected Object doInBackground(Object... params) {
            int message = (Integer) params[0];
            switch (message) {
                case MESSAGE_CLEAR:
                    clearCacheInternal();
                    break;
